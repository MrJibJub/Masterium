...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_all( 
      ...
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,  KC_EQL,  KC_BSPC, KC_NUBS, KC_INS,   KC_HOME, KC_PGUP,     KC_NUM,    KC_PSLS,   KC_PAST,  KC_PMNS,
      ...
      KC_LCTL, KC_LGUI, KC_LALT,          KC_SPC,           KC_SPC,           KC_SPC,           KC_RALT, MO(1),  KC_APP,  KC_RCTL,          KC_LEFT,  KC_DOWN, KC_RIGHT,    KC_P0,     KC_NO,     KC_PDOT
    ),
    [1] = LAYOUT_all(
